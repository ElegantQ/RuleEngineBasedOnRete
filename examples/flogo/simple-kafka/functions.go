...
func init() {
	configuration.RegisterConditionEvaluator("checkForGrocery", checkForGrocery)
	configuration.RegisterActionFunction("groceryAction", groceryAction)

	configuration.RegisterConditionEvaluator("checkForFurniture", checkForFurniture)
	configuration.RegisterActionFunction("furnitureAction", furnitureAction)
